<template>
  <Layout>
    <h1 class="entry-title main_title">Impressum</h1>
					...
					<p>Marcell Lanczos<br>Inhaber des Unternehmens: Marcell Lanczos<br>Krenngasse 5/3<br>1180 Vienna<br>Österreich<br><a href="mailto:marcell@studio-seis.at">marcell@studio-seis.at</a><br>Telefon: <br>Umsatzsteuer-Identifikationsnummer: ATU 74388209</p>
